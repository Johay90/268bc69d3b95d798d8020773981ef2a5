...
// @description  urmum
// @author       Johay
// @match        https://www.gangsternation.net/*
...
TODO Random Error 400s (Prison)

TODO Code cleanup / Restructure (LUL GOOD ONE)
*/
(function() {
  var inJail;
  var cycle = 0;
            ...
            setTimeout(function() {
              ...
              setTimeout(function() {
                ...
                if (str.search("Hours") != -1) {
                  if (parseInt(str.substring(0, 2)) >= 16) {
          ...
          if ($("#page-fraud-attempt").attr('class') != "page-content area-fraud disabled") {
            if ($.trim($('#content > gn-page > div > header > h1').text()) == "Fraud") {
              ...
              if ($.trim($('#page-fraud-attempt > div.content-general > div > button.primary.attempt > div').text()) != 0) {
                if (parseInt($.trim($('#page-fraud-attempt > div.content-general > div > button.primary.attempt > div').text().match(/(\d+)/g))) < 79) {
                  $('#page-fraud-attempt > div.content-general > div > button.secondary.plan')[0].click();
                } else if (parseInt($.trim($('#page-fraud-attempt > div.content-general > div > button.primary.attempt > div').text().match(/(\d+)/g))) >= 79) {
